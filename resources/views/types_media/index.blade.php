...
<style>
    ...
    #TypesMediaTable thead th:last-child {
        border-right: none;
    }

    #TypesMediaTable thead th:first-child {
        width: 20%;
    ...
    #TypesMediaTable tbody td:last-child {
        border-right: none;
        text-align: center;
    }

    #TypesMediaTable tbody tr {
        transition: all 0.2s ease;
    }

    #TypesMediaTable tbody tr:hover {
        box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);
    }

    #TypesMediaTable tbody tr:hover td {
...
<div class="page-container">
    ...
    <div id="deleteModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Êtes-vous sûr de vouloir supprimer ce type de média <strong id="typeName"></strong> ?</p>
    ...
    <div class="controls-container">
        ...
        <div class="controls-right">
            <a href="{{route('types_media.create')}}" class="btn-create">
    ...
    <div class="table-container">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Types de Média</h3>
            </div>
            <div class="card-body">

                <div class="table-responsive">
                    <table id="TypesMediaTable" class="table display">
                        <thead>
                            <tr>
                                <th>Nom du Type</th>
                                <th>Actions</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $type->nom_type }}</td>
                                <td>
                                    <a href="{{ route('types_media.show', $type->id_type) }}"
                                        class="btn-action btn-show" title="Voir">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('types_media.edit', $type->id_type) }}"
                                        class="btn-action btn-edit" title="Modifier">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('types_media.destroy', $type->id_type) }}" method="POST"
                                        ...
                                        <button type="button" class="btn-action btn-delete" title="Supprimer"
                                            onclick="showDeleteModal('{{ $type->id_type }}', '{{ $type->nom_type }}')">
