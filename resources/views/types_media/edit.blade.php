...
<div class="create-page">
    <div class="create-container">
        <div class="card">
            ...
            <form action="{{ route('types_media.update', $type_media->id_type) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="nom_type" 
                            name="nom_type" 
                            value="{{ old('nom_type', $type_media->nom_type) }}" 
                            required
                        >
                        <small class="form-text">Nom unique du type de média</small>
                        @error('nom_type')
                ...
                <div class="card-footer">
                    <a href="{{ route('types_media.index') }}" class="btn btn-secondary">
