...
<style>
    ...
    #MediasTable thead th:last-child {
        border-right: none;
    }

    #MediasTable thead th:first-child {
        width: 20%;
    ...
    #MediasTable tbody td:last-child {
        border-right: none;
        text-align: center;
    }

    #MediasTable tbody tr {
        transition: all 0.2s ease;
    }
...
<div class="page-container">
    ...
    <div class="controls-container">
        ...
        <div class="controls-right">
            <a href="{{route('medias.create')}}" class="btn-create">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="MediasTable" class="table display">
                        <thead>
                            <tr>
                                <th>Chemin</th>
                                <th>Description</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ Str::limit($media->chemin, 30) }}</td>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('medias.destroy', $media->id_media) }}" method="POST"
                                        ...
                                        <button type="button" class="btn-action btn-delete" title="Supprimer"
                                            onclick="showDeleteModal('{{ $media->id_media }}')">
