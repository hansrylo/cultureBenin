...
<style>
    ...
    #TypesContenuTable thead th:last-child {
        border-right: none;
    }

    #TypesContenuTable thead th:first-child {
        width: 20%;
    ...
    #TypesContenuTable tbody td:last-child {
        border-right: none;
        text-align: center;
    }

    #TypesContenuTable tbody tr {
        transition: all 0.2s ease;
    }

    #TypesContenuTable tbody tr:hover {
        box-shadow: 0 2px 8px rgba(0, 0, 0, 0.08);
    }

    #TypesContenuTable tbody tr:hover td {
...
<div class="page-container">
    ...
    <div id="deleteModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Êtes-vous sûr de vouloir supprimer ce type de contenu <strong id="typeName"></strong> ?</p>
    ...
    <div class="controls-container">
        ...
        <div class="controls-right">
            <a href="{{route('types_contenu.create')}}" class="btn-create">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="TypesContenuTable" class="table display">
                        <thead>
                            <tr>
                                <th>Nom du Type</th>
                                <th>Actions</th>
                        ...
                        <tbody>
                            @foreach ($types_contenu as $type)
                            <tr>
                                <td>{{ $type->nom }}</td>
                                <td>
                                    <a href="{{ route('types_contenu.show', $type->id_type) }}"
                                        class="btn-action btn-show" title="Voir">
                                        <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="{{ route('types_contenu.edit', $type->id_type) }}"
                                        class="btn-action btn-edit" title="Modifier">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <form action="{{ route('types_contenu.destroy', $type->id_type) }}" method="POST"
                                        ...
                                        <button type="button" class="btn-action btn-delete" title="Supprimer"
                                            onclick="showDeleteModal('{{ $type->id_type }}', '{{ $type->nom }}')">
...
<script>
    ...
    function showDeleteModal(id, name) {
        ...
        const nameSpan = document.getElementById('typeName');
        
        form.action = `/types_contenu/${id}`;
