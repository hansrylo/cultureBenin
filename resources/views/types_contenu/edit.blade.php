...
<div class="create-page">
    <div class="create-container">
        <div class="card">
            ...
            <form action="{{ route('types_contenu.update', $type_contenu->id_type) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="nom" 
                            name="nom" 
                            value="{{ old('nom', $type_contenu->nom) }}" 
                            required
                        >
                        <small class="form-text">Nom unique du type de contenu</small>
                        @error('nom')
                ...
                <div class="card-footer">
                    <a href="{{ route('types_contenu.index') }}" class="btn btn-secondary">
