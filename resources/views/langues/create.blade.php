            ...
            <form action="{{ route('langues.store') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <label for="code_langue">
                            Code Langue <span class="required">*</span>
                        </label>
                        <input 
                            type="text" 
                            ...
                            required
                        >
                        <small class="form-text">Code unique de la langue (maximum 10 caractères)</small>
                        @error('code_langue')
                    ...
                    <!-- Nom Langue -->
                    <div class="form-group">
                        <label for="nom_langue">
                            Nom de la langue <span class="required">*</span>
                        </label>
                        <input 
                            type="text" 
                            ...
                            placeholder="Ex: Français, English, Fongbé"
                            required
                        >
                        <small class="form-text">Nom complet de la langue</small>
                        @error('nom_langue')
                            <small style="color: #dc3545; display: block; margin-top: 0.25rem;">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            ...
                            id="description" 
                            name="description"
                            placeholder="Description ou informations supplémentaires sur cette langue (optionnel)"
