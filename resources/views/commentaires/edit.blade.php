                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea 
                            ...
                            name="texte"
                            required
                        >{{ old('texte', $commentaire->texte) }}</textarea>
                        @error('texte')
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            max="10"
                        >
                        <small class="form-text">Note sur 10 (optionnel)</small>
                        @error('note')
                            <small style="color: #dc3545; display: block; margin-top: 0.25rem;">{{ $message }}</small>
                        @enderror
                    </div>
                    ...
                    <div class="form-group">
                        <label for="id_utilisateur">
                            ID Utilisateur <span class="required">*</span>
                        </label>
                        <input 
                            type="number" 
                            class="form-control @error('id_utilisateur') is-invalid @enderror" 
                            id="id_utilisateur" 
                            name="id_utilisateur" 
                            value="{{ old('id_utilisateur', $commentaire->id_utilisateur) }}" 
                            required
                        >
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            id="id_contenu" 
                            name="id_contenu" 
                            value="{{ old('id_contenu', $commentaire->id_contenu) }}" 
                            required
                        >
                        @error('id_contenu')
                            <small style="color: #dc3545; display: block; margin-top: 0.25rem;">{{ $message }}</small>
