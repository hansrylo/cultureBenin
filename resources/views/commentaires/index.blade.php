...
<style>
    ...
    #CommentairesTable thead th:last-child {
        border-right: none;
    }

    #CommentairesTable thead th:first-child {
        width: 10%;
    ...
    #CommentairesTable tbody td:last-child {
        border-right: none;
        text-align: center;
    }

    #CommentairesTable tbody tr {
        transition: all 0.2s ease;
    }
    ...
    #CommentairesTable tbody tr:hover td {
...
<div class="page-container">
    ...
    <div class="controls-container">
        ...
        <div class="controls-right">
            <a href="{{route('commentaires.create')}}" class="btn-create">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="CommentairesTable" class="table display">
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Texte</th>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('commentaires.destroy', $commentaire->id_commentaire) }}" method="POST"
                                        ...
                                        <button type="button" class="btn-action btn-delete" title="Supprimer"
                                            onclick="showDeleteModal('{{ $commentaire->id_commentaire }}')">
