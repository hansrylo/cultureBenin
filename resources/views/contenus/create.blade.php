                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select 
                            ...
                            name="statut" 
                            required>
                            <option value="en attente" {{ old('statut') == 'en attente' ? 'selected' : 'selected' }}>En attente</option>
                    ...
                    <div class="form-group" style="background: #f8f9fa; padding: 1rem; border-radius: 4px; border: 1px solid #e9ecef;">
                        ...
                        <div id="prix_container" style="display: {{ old('est_premium') ? 'block' : 'none' }};">
                            <label for="prix">
                    ...
                    <div class="form-group">
                        ...
                        <select 
                            ...
                            @foreach($contenus as $c)
                                <option value="{{ $c->id_contenu }}" {{ old('parent') == $c->id_contenu ? 'selected' : '' }}>
                                    {{ $c->titre }}
                                </option>
                            @endforeach
                        </select>
