    ...
    <div id="deleteModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Êtes-vous sûr de vouloir supprimer ce rôle <strong id="roleName"></strong> ?</p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="RolesTable" class="table display">
                        <thead>
                            <tr>
                                <th>Nom du Rôle</th>
                                <th>Actions</th>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('roles.destroy', $role->id_role) }}" method="POST"
                                        ...
                                        <button type="button" class="btn-action btn-delete" title="Supprimer"
                                            onclick="showDeleteModal('{{ $role->id_role }}', '{{ $role->nom_role }}')">
...
<script>
    ...
    function showDeleteModal(id, name) {
        ...
        const nameSpan = document.getElementById('roleName');
